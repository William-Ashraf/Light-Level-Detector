...
void DIO_voidSetPinDirection(u8 Copy_u8PortId,u8 Copy_u8PinId,u8 Copy_u8Direction)
{
  ...
  u8 DIO_u8GETPinValue(u8 Copy_u8PortId,u8 Copy_u8PinId){
	...
	if (( Copy_u8PortId <=  PORT_D)&&(Copy_u8PinId <= PIN7  )){
		 ...
		 switch(Copy_u8PortId){
				   ...
				   case PORT_A : LOCAL_u8RetVar = GET_BIT(PINA ,Copy_u8PinId);
				               break;
				   case PORT_B : LOCAL_u8RetVar = GET_BIT(PINB ,Copy_u8PinId);
				 		               break;
				   case PORT_C : LOCAL_u8RetVar = GET_BIT(PINC ,Copy_u8PinId);
				 		               break;
				   case PORT_D : LOCAL_u8RetVar = GET_BIT(PIND ,Copy_u8PinId);
				 		               break;         }
				                                                }
 ...
 u8 DIO_u8GetPORTValue(u8 Copy_u8PortId,u8 Copy_u8Value){
 	u8 LOCAL_u8RetVar;
